      ...
      <div class="container">
        <div class="row" style="padding-top: 10px;">
          <div class="col-md-12 d-flex justify-content-between">
            <div><h1>Assign Task for <?php echo $_SESSION["displayname"]; ?></h1></div>
            <div>
        ...
        <?php if ($status == "All") { ?>
         <div class="col-md-3">
            <a href="assigned.php?status=All" class="btn btn-dark form-control">All Release (<?php echo $statusdisplayall['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="assigned.php?status=All" class="btn btn-info account-button form-control">All Release (<?php echo $statusdisplayall['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "Ongoing") { ?>
          <div class="col-md-3">
            <a href="assigned.php?status=Ongoing" class="btn btn-dark form-control">Ongoing Release (<?php echo $statusdisplayongoing['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="assigned.php?status=Ongoing" class="btn btn-info account-button form-control">Ongoing Release (<?php echo $statusdisplayongoing['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "For Review") { ?>
          <div class="col-md-3">
            <a href="assigned.php?status=For Review" class="btn btn-dark form-control">For Review (<?php echo $statusdisplayforreview['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="assigned.php?status=For Review" class="btn btn-info account-button form-control">For Review (<?php echo $statusdisplayforreview['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "Approved") { ?>
          <div class="col-md-3">
            <a href="assigned.php?status=Approved" class="btn btn-dark form-control">Approved (<?php echo $statusdisplayapproved['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="assigned.php?status=Approved" class="btn btn-info account-button form-control">Approved (<?php echo $statusdisplayapproved['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
                ...
                <tbody class="text-center">
                  ...
                  <tr>
                    ...
                    <td style="font-size: 20px;">
                      <?php if ($usersession == 1) { ?>
                      <a href="assigned.php?approved=<?php echo($productreleasetablerow['id']) ?>&status=<?php echo($status) ?>" class="viewicon btn btn-success" style="padding-left: 3px; padding-right: 3px;">
                 ...
                 ?>
                  ...
                  <div class="editmicrobiologicaltesting" style="padding-top: 10px; padding-bottom: 2px;">
                    <div class="row" style="padding-top: 2px;padding-bottom: 2px;">
                      <div class="col-md-5"><b>Microbiological Testing</b></div>
                      <div class="col-md-4"><b>cfu/g</b></div>
                      <div class="col-md-2 text-center"><b>Input</b></div>
                    </div>
                    <?php 
