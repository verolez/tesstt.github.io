            ...
            <div class="col-md-5 mx-auto" style="background-color:white; font-size: 20px;">
              <div style="padding: 20px;">
                <div class="form-group">
                  ...
                  <span style="color: red;font-size: 17px;"><?php echo $oldpassword_err; ?></span>
                </div>
                <div class="form-group">
                  <label>New Password</label>
                  <input class="form-control" type="password" name="newpassword" placeholder="New Password" required>
                  <span style="color: red;font-size: 17px;"><?php echo $newpassword_err; ?></span>
                </div>
                <div class="form-group">
                  <label>Confirm New Password</label>
                  <input class="form-control" type="password" name="confirmnewpassword" placeholder="Confirm New Password" required>
                  <span style="color: red;font-size: 17px;"><?php echo $confirmnewpassword_err; ?></span>
                </div>
                ...
                <div class="form-group d-flex justify-content-between">
                  <button type="submit" name="change" class="btn btn-success form-control">CHANGE PASSWORD</button>
                </div>
              </div>
            </div>
          </div>
