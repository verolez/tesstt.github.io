...
include 'function/dashboardfunction.php';  
?>
<body>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
      <div class="container">
        ...
        <div class="row">
          <?php 
          for ($displaycolor = 0; $dashboardaccountrow = $dashboardaccount->fetch_assoc();$displaycolor++) {
            ?>
            <div class="col-md-3" style="padding-top:10px; padding-bottom: 10px;">
            <a href="productrelease.php?account=<?php echo($dashboardaccountrow['account_name']) ?>&status=All" class="btn btn-info btn-lg account-button">
              <?php echo $dashboardaccountrow['account_name']; ?> (<?php echo $dashboardaccountrow['COUNT(productrelease.id)']; ?>)
            </a>
          </div>
          <?php
          }
            ...
            <div class="table-responsive fixed-table-body">
              <table id="example" class="table table-hover table-bordered">
                ...
                <tbody class="text-center">
                  <?php 
                  for ($i = 0;$producttablerow = $producttable->fetch_assoc();$i++) 
                    { ?>
                  <tr>
                    <td><?php echo $producttablerow['id']; ?></td>
                    <td><?php echo $producttablerow['control_num']; ?></td>
                    <td><?php echo $producttablerow['lot_num']; ?></td>
                    <td><?php echo $producttablerow['account']; ?></td>
                    <td style="color: <?php if ($producttablerow['status'] == "Ongoing") { echo "gray"; } elseif ($producttablerow['status'] == "For Review") { echo "blue"; } elseif ($producttablerow['status'] == "Approved") { echo "green"; } ?>;"><?php echo $producttablerow['status']; ?></td>
                    <td><?php echo $producttablerow['assign_to']; ?></td>
                    <td><?php echo date("F d, Y", strtotime($producttablerow['date_added'])); ?></td>
                    <!-- <td><?php echo date("F d, Y", strtotime($producttablerow['date_modified'])); ?></td> -->
                    <td style="font-size: 20px;">
                    <?php if ($usersession == 1) { ?>
                      <a href="index.php?approved=<?php echo($producttablerow['id']) ?>" class="viewicon btn btn-success" style="padding-left: 3px; padding-right: 3px;">
          ...
          <form method="post">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="addnewaccount" style="font-size: 17px;" class="btn btn-primary">Add Account</button>
                  <!-- <a href="main.php?delete=<?php echo($productdeleterow['id']) ?>" name="delete" style="font-size: 17px;" class="btn btn-danger">Delete</a> -->
              </div>
            </div>
         </form>
        </div>
...
<!-- View Modal Start -->
<?php for ($j=0;$productviewrow = $productview->fetch_assoc(); $j++) { ?>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="container">
          <div class="content">
          <div class="modal-header">
              <h4 class="modal-title" id="viewproductTitle">View <?php echo $productviewrow['product_name']; ?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
          </div>
          <div class="modal-body">
              ...
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Product Name
                  ...
                  <div class="col-md-9"> : <b><?php echo $productviewrow['product_name']; ?></b></div>
              </div>

              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Customer Name
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['customer_name']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Account
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['account']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Created by
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['created_by']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Assign Review
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['assign_to']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Manufacture Date
                  </div>
                  <div class="col-md-9"> : <b><?php echo date("F d, Y", strtotime($productviewrow['manufacture_date'])); ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Expiration Date
                  </div>
                  <div class="col-md-9"> : <b><?php echo date("F d, Y", strtotime($productviewrow['expiration_date']));  ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Manufactured Quantity
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['manufactured_quantity']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Control Number
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['control_num']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">PO #
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['po_num']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Lot Number
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['lot_num']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Product Code
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['item_num']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Rev. Number
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['rev_num']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Serving Size
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['serving_size']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Serving Per Container
                  </div>
                  <div class="col-md-9"> : <b><?php echo $productviewrow['serving_per']; ?></b></div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-3">Status
                  </div>
                  <div class="col-md-9"> : <span style="color: <?php if ($productviewrow['status'] == "Ongoing") { echo "gray"; }elseif($productviewrow['status'] == "For Review") { echo "blue"; } elseif ($productviewrow['status'] == "Approved") { echo "green"; }?> ;"><b><?php echo $productviewrow['status']; ?></b></span></div>
              </div>
              <hr>
                  <div style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <?php 
                    $viewphysicaltest = explode("|", $productviewrow['physicaltest']);
                    $viewphysicaltestarraylength = count($viewphysicaltest);
                    $viewphysicalspecification = explode("|", $productviewrow['physicalspecification']);
                    $viewphysicalspecificationarraylength = count($viewphysicalspecification);
                    $viewphysicalmethod = explode("|", $productviewrow['physicalmethod']);
                    $viewphysicalmethodarraylength = count($viewphysicalmethod);
                    $viewphysicalresults = explode("|", $productviewrow['physicalresults']);
              ...
              <div class="col-md-12">
                <ul style="list-style-type: disc; padding-left: 20px;" >
                  ...
                  <div style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <?php 
                      $viewchemicaltest = explode("|", $productviewrow['chemicaltest']);
                      $viewchemicaltestarraylength = count($viewchemicaltest);
                      $viewchemicalunit = explode("|", $productviewrow['chemicalunit']);
                      $viewchemicalunitarraylength = count($viewchemicalunit);
                      $viewchemicalmin = explode("|", $productviewrow['chemicalmin']);
                      $viewchemicalminarraylength = count($viewchemicalmin);
                      $viewchemicalmax = explode("|", $productviewrow['chemicalmax']);
                      $viewchemicalmaxarraylength = count($viewchemicalmax);
                      $viewchemicalinput = explode("|", $productviewrow['chemicalinput']);
                  ...
                  <div style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <?php 
                    $viewheavymetaltest = explode("|", $productviewrow['heavymetaltest']);
                    $viewheavymetaltestarraylength = count($viewheavymetaltest);

                    $viewheavymetalug = explode("|", $productviewrow['heavymetalug']);
                    $viewheavymetalugarraylength = count($viewheavymetalug);

                    $viewheavymetalinput = explode("|", $productviewrow['heavymetalinput']);
                  ...
                  <div style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <?php 
                    $viewmicrobiologicaltest = explode("|", $productviewrow['microbiologicaltest']);
                    $viewmicrobiologicaltestarraylength = count($viewmicrobiologicaltest);

                    $viewmicrobiologicalcfu = explode("|", $productviewrow['microbiologicalcfu']);
                    $viewmicrobiologicalcfuarraylength = count($viewmicrobiologicalcfu);

                    $viewmicrobiologicalinput = explode("|", $productviewrow['microbiologicalinput']);
                  ...
                  <div style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <div class="row" style="padding-top: 2px;padding-bottom: 2px;">
                      <div style="color:<?php if ($productviewrow['coa'] == "Submitted") { echo "green"; } else { echo "gray"; } ?>;" class="col-md-4 text-center">
                          <?php echo $productviewrow['coa']; ?>
                        </div>
                        <div style="color:<?php if ($productviewrow['batchrecord'] == "Submitted") { echo "green"; } else { echo "gray"; } ?>;" class="col-md-4 text-center">
                          <?php echo $productviewrow['batchrecord']; ?>
                        </div>
                        <div style="color:<?php if ($productviewrow['ftir'] == "Submitted") { echo "green"; } else { echo "gray"; } ?>;" class="col-md-4 text-center">
                          <?php echo $productviewrow['ftir']; ?>
                        </div>
                    </div>
                  </div>
                  <hr>
                  <?php
                    $viewpreparedname = explode("|", $productviewrow['preparedname']);
                    $viewpreparednamearraylength = count($viewpreparedname);
                    $viewprepareddescription = explode("|", $productviewrow['prepareddescription']);
                    $viewprepareddescriptionarraylength = count($viewprepareddescription);
                    $viewreviewedname = explode("|", $productviewrow['reviewedname']);
                    $viewreviewednamearraylength = count($viewreviewedname);
                    $viewrevieweddescription = explode("|", $productviewrow['revieweddescription']);
                    $viewrevieweddescriptionarraylength = count($viewrevieweddescription);
                    $viewapprovedname = explode("|", $productviewrow['approvedname']);
                    $viewapprovednamearraylength = count($viewapprovedname);
                    $viewapproveddescription = explode("|", $productviewrow['approveddescription']);
                    $viewapproveddescriptionarraylength = count($viewapproveddescription);
                    $viewauthorizedname = explode("|", $productviewrow['authorizedname']);
                    $viewauthorizednamearraylength = count($viewauthorizedname);
                    $viewauthorizeddescription = explode("|", $productviewrow['authorizeddescription']);
            ...
            <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
              <div class="col-md-12">
                ...
                <textarea class="form-control" name="addcomment" style="height: 150px;" disabled placeholder="No History Change Log and Comment"><?php echo $productviewrow['comment']; ?></textarea>
              </div>
            </div>
         </div>
            <div class="row">
              <div class="col-md-6"><a href="viewnewtab.php?generate=<?php echo($productviewrow['id']) ?>" target="_blank" name="generatetable" style="font-size: 17px;" class="btn btn-primary form-control">View Table in New Tab</a></div>
              <div class="col-md-6"><a href="generated-productrelease.php?generate=<?php echo($productviewrow['id']) ?>" target="_blank" name="generate" style="font-size: 17px;" class="btn btn-success form-control">Generate Product Release Statement</a></div>
            </div>
            </div>
        </div>
      </div>
...
<!-- Edit Modal Start -->
<?php for ($k=0;$producteditrow = $productedit->fetch_assoc(); $k++) { ?>
      ...
      <div class="modal-content">
        <div class="container">
          <div class="content">
            <form method="post" autocomplete="off">
              <div class="modal-header">
                  <h4 class="modal-title" id="viewproductTitle">Edit <?php echo $producteditrow['product_name']; ?></h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  <!-- Modal Content -->
                <input type="hidden" name="editid" value="<?php echo($producteditrow['id']) ?>">
                <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                  <div class="col-md-12">
                    Product Name
                    <input type="text" name="editproductname" class="form-control" required value="<?php echo ($producteditrow['product_name']) ?>">
                  </div>
                </div>
                ...
                <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                  <div class="col-md-6">
                    Customer Name
                    <input type="text" name="editcustomername" class="form-control" required value="<?php echo ($producteditrow['customer_name']) ?>">
                  </div>
                  <div class="col-md-6">
                  Account
                  ...
                  for ($random = 0; $random < $assignaccountmax; $random++) { 
                    ?>
                    <option <?php if ($producteditrow['account'] == $assignaccount[$random]) { echo 'selected="selected"'; } ?> value="<?php echo($assignaccount[$random]) ?>"><?php echo $assignaccount[$random]; ?></option>
                    <?php
                  } ?>
                  </select>
                </div>
              ...
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-6">
                  Created by
                  <input type="text" name="editcreatedby" class="form-control" required value="<?php echo ($producteditrow['created_by']) ?>">
                </div>
                <div class="col-md-6">
                  Assign Review
                  <select name="editassignto" class="form-control" required>
                    ...
                    for ($random = 0; $random < $assignpersonmax; $random++) { 
                      ?>
                      <option <?php if ($producteditrow['assign_to'] == $assignperson[$random]) { echo 'selected="selected"'; } ?> value="<?php echo($assignperson[$random]) ?>"><?php echo $assignperson[$random]; ?></option>
                      <?php
                    }
                     ?>
                  </select>
              ...
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-6">
                  Manufacture Date
                  <input type="date" name="editmanufacturedate" class="form-control" required value="<?php echo ($producteditrow['manufacture_date']) ?>">
                </div>
                <div class="col-md-6">
                  Expiration Date
                  <input type="date" name="editexpirationdate" class="form-control" required value="<?php echo ($producteditrow['expiration_date']) ?>">
                </div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-4">
                  Manufactured Quantity
                  <input type="text" name="editmanufacturedquan" class="form-control" required value="<?php echo ($producteditrow['manufactured_quantity']) ?>">
                </div>
                <div class="col-md-4">
                  Control Number
                  <input type="text" name="editcontrolnum" class="form-control" required value="<?php echo ($producteditrow['control_num']) ?>">
                </div>
                <div class="col-md-4">
                  PO #
                  <input type="text" name="editponum" class="form-control" required value="<?php echo ($producteditrow['po_num']) ?>">
                </div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-4">
                  Lot Number
                  <input type="text" name="editlotnum" class="form-control" required value="<?php echo ($producteditrow['lot_num']) ?>">
                </div>
                <div class="col-md-4">
                  Product Code
                  <input type="text" name="edititemnum" class="form-control" required value="<?php echo ($producteditrow['item_num']) ?>">
                </div>
                <div class="col-md-4">
                  Rev. Number
                  <input type="text" name="editrevnum" class="form-control" required value="<?php echo ($producteditrow['rev_num']) ?>">
                </div>
              </div>
              <div class="row" style="padding-top: 3px; padding-bottom: 3px;">
                <div class="col-md-4">
                  Serving Size
                  <input type="text" name="editservingsize" class="form-control" required value="<?php echo ($producteditrow['serving_size']) ?>">
                </div>
                <div class="col-md-4">
                  Serving Per Container
                  <input type="text" name="editservingpercontainer" class="form-control" required value="<?php echo ($producteditrow['serving_per']) ?>">
                </div>
                <div class="col-md-4">
                  Status
                  <select name="editstatus" class="form-control" required>
                      <option  <?php  if($producteditrow['status'] == 'Ongoing') { echo 'selected="selected"'; } ?> value="Ongoing">Ongoing</option>
                        <option  <?php  if($producteditrow['status'] == 'For Review') { echo 'selected="selected"'; } ?> value="For Review">For Review</option>
                        <?php 
                        if($producteditrow['status'] == 'Approved') { ?>
              ...
              <hr>
                <?php 
                    $editphysicaltest = explode("|", $producteditrow['physicaltest']);
                    $editphysicaltestarraylength = count($editphysicaltest);
                    $editphysicalspecification = explode("|", $producteditrow['physicalspecification']);
                    $editphysicalspecificationarraylength = count($editphysicalspecification);
                    $editphysicalmethod = explode("|", $producteditrow['physicalmethod']);
                    $editphysicalmethodarraylength = count($editphysicalmethod);
                    $editphysicalresults = explode("|", $producteditrow['physicalresults']);
                 ...
                 ?>
                  ...
                  <?php 
                      $editchemicaltest = explode("|", $producteditrow['chemicaltest']);
                      $editchemicaltestarraylength = count($editchemicaltest);
                      $editchemicalunit = explode("|", $producteditrow['chemicalunit']);
                      $editchemicalunitarraylength = count($editchemicalunit);
                      $editchemicalmin = explode("|", $producteditrow['chemicalmin']);
                      $editchemicalminarraylength = count($editchemicalmin);
                      $editchemicalmax = explode("|", $producteditrow['chemicalmax']);
                      $editchemicalmaxarraylength = count($editchemicalmax);
                      $editchemicalinput = explode("|", $producteditrow['chemicalinput']);
                  ...
                  <?php 
                    $editheavymetaltest = explode("|", $producteditrow['heavymetaltest']);
                    $editheavymetaltestarraylength = count($editheavymetaltest);
                    $editheavymetalug = explode("|", $producteditrow['heavymetalug']);
                    $editheavymetalugarraylength = count($editheavymetalug);
                    $editheavymetalinput = explode("|", $producteditrow['heavymetalinput']);
                  ...
                  <?php 
                    $editmicrobiologicaltest = explode("|", $producteditrow['microbiologicaltest']);
                    $editmicrobiologicaltestarraylength = count($editmicrobiologicaltest);
                    $editmicrobiologicalcfu = explode("|", $producteditrow['microbiologicalcfu']);
                    $editmicrobiologicalcfuarraylength = count($editmicrobiologicalcfu);
                    $editmicrobiologicalinput = explode("|", $producteditrow['microbiologicalinput']);
                  ...
                  <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <div class="col-md-4 text-center">
                      ...
                      <select name="editcoa" class="form-control" required>
                          <option  <?php  if($producteditrow['coa'] == 'Not Submitted') { echo 'selected="selected"'; } ?> value="Not Submitted">Not Submitted</option>
                          <option  <?php  if($producteditrow['coa'] == 'Submitted') { echo 'selected="selected"'; } ?> value="Submitted">Submitted</option>
                      </select>
                    </div>
                    <div class="col-md-4 text-center">
                      Batch Record
                      <select name="editbatchrecord" class="form-control" required>
                          <option  <?php  if($producteditrow['batchrecord'] == 'Not Submitted') { echo 'selected="selected"'; } ?> value="Not Submitted">Not Submitted</option>
                          <option  <?php  if($producteditrow['batchrecord'] == 'Submitted') { echo 'selected="selected"'; } ?> value="Submitted">Submitted</option>
                      </select>
                    </div>
                    <div class="col-md-4 text-center">
                      FTIR
                      <select name="editftir" class="form-control" required>
                          <option  <?php  if($producteditrow['ftir'] == 'Not Submitted') { echo 'selected="selected"'; } ?> value="Not Submitted">Not Submitted</option>
                          <option  <?php  if($producteditrow['ftir'] == 'Submitted') { echo 'selected="selected"'; } ?> value="Submitted">Submitted</option>
                      </select>
                    </div>
                  </div>
                  <?php 
                    $editpreparedname = explode("|", $producteditrow['preparedname']);
                    $editpreparednamearraylength = count($editpreparedname);

                    $editprepareddescription = explode("|", $producteditrow['prepareddescription']);
                    $editprepareddescriptionarraylength = count($editprepareddescription);

                    $editreviewedname = explode("|", $producteditrow['reviewedname']);
                    $editreviewednamearraylength = count($editreviewedname);

                    $editrevieweddescription = explode("|", $producteditrow['revieweddescription']);
                    $editrevieweddescriptionarraylength = count($editrevieweddescription);

                    $editapprovedname = explode("|", $producteditrow['approvedname']);
                    $editapprovednamearraylength = count($editapprovedname);

                    $editapproveddescription = explode("|", $producteditrow['approveddescription']);
                    $editapproveddescriptionarraylength = count($editapproveddescription);

                    $editauthorizedname = explode("|", $producteditrow['authorizedname']);
                    $editauthorizednamearraylength = count($editauthorizedname);

                    $editauthorizeddescription = explode("|", $producteditrow['authorizeddescription']);
                  ...
                  <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                    <div class="col-md-12">
                      ...
                      <textarea class="form-control" style="height: 150px;" disabled><?php echo ($producteditrow['comment']) ?></textarea>
                    </div>
                  </div>
              </div>
              <div class="modal-footer">
...
<?php for ($l=0;$productdeleterow = $productdelete->fetch_assoc(); $l++) { ?>
    ...
    <div class="modal-content">
        <div class="container">
          <form method="post">
            <div class="content">
              <div class="modal-header">
                  <h4 class="modal-title" id="deleteproductLabel">Delete <?php echo $productdeleterow['product_name']; ?></h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  Are you sure you want to Delete <?php echo $productdeleterow['product_name']; ?>?
                  <input type="hidden" name="deleteid" value=" <?php echo($productdeleterow['id']) ?> ">
              </div>
            <div class="modal-footer">
                <button type="button" style="font-size: 17px;" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
