...
<body>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
      <div class="container">
        ...
        <?php if ($status == "All") { ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=All" class="btn btn-dark form-control">All Release (<?php echo $allreleasestatusdisplayall['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=All" class="btn btn-info account-button form-control">All Release (<?php echo $allreleasestatusdisplayall['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "Ongoing") { ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=Ongoing" class="btn btn-dark form-control">Ongoing Release (<?php echo $allreleasestatusdisplayongoing['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=Ongoing" class="btn btn-info account-button form-control">Ongoing Release (<?php echo $allreleasestatusdisplayongoing['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "For Review") { ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=For Review" class="btn btn-dark form-control">For Review (<?php echo $allreleasestatusdisplayforreview['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=For Review" class="btn btn-info account-button form-control">For Review (<?php echo $allreleasestatusdisplayforreview['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        <?php if ($status == "Approved") { ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=Approved" class="btn btn-dark form-control">Approved (<?php echo $allreleasestatusdisplayapproved['COUNT(id)']; ?>)</a>
          </div>
        <?php }else{ ?>
          <div class="col-md-3">
            <a href="allrelease.php?status=Approved" class="btn btn-info account-button form-control">Approved (<?php echo $allreleasestatusdisplayapproved['COUNT(id)']; ?>)</a>
          </div>
        <?php } ?>
        </div>
      </div>    
                ...
                <tbody class="text-center">
                  ...
                  <tr>
                    ...
                    <td style="font-size: 20px;">
                      <?php if ($usersession == 1) { ?>
                      <a href="allrelease.php?approved=<?php echo($productreleasetablerow['id']) ?>" class="viewicon btn btn-success" style="padding-left: 3px; padding-right: 3px;">
